...
config_arg6='-Dccflags=-DDEBIAN -Wdate-time -D_FORTIFY_SOURCE=2 -g -O2 -fdebug-prefix-map=/build/perl-V_SFux/perl-5.28.1=. -fstack-protector-strong -Wformat -Werror=format-security'
...
libspath=' /usr/local/lib /usr/lib/gcc/arm-linux-gnueabihf/8/include-fixed /usr/include/arm-linux-gnueabihf /usr/lib /lib/arm-linux-gnueabihf /lib/../lib /usr/lib/arm-linux-gnueabihf /usr/lib/../lib /lib'
...
phostname='hostname'
pidtype='pid_t'
plibpth='/lib/arm-linux-gnueabihf/8 /lib/arm-linux-gnueabihf /lib/../lib /usr/lib/arm-linux-gnueabihf/8 /usr/lib/arm-linux-gnueabihf /usr/lib/../lib /lib /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
